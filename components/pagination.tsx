      ...
      {visiblePages.map((page, key) => {
        ...
        return (
          <Link
            ...
            key={key}
            className={`px-3 py-2 text-sm font-medium rounded-lg ${isCurrentPage ? "bg-purple-600 text-white" : "text-gray-700 hover:bg-gray-100 bg-white border boder-gray-300"}`}
          >
            {pageNumber}
          </Link>
        );
